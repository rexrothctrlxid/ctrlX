      ...
      <div className='container'>
        <lu>
          ...
          <h4>B. Membuat Flow Pada Node-RED</h4>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', marginTop: '5px', marginBottom: '30px' }}>
              <img className="materialboxed" src={picture2} alt="hmi" style={{ maxWidth: '80%', height: 'auto', borderRadius: '10px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }} />
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', marginTop: '5px', marginBottom: '30px' }}>
              <img className="materialboxed" src={picture3} alt="hmi" style={{ maxWidth: '80%', height: 'auto', borderRadius: '10px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }} />
            </div>
            <p>3.	Jika sudah selesai, tekan Deploy di pojok kanan atas</p>
            <div style={{ display: 'flex', justifyContent: 'center', marginTop: '5px', marginBottom: '30px' }}>
              <img className="materialboxed" src={picture4} alt="hmi" style={{ maxWidth: '80%', height: 'auto', borderRadius: '10px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }} />
            </div>
          ...
          <h4>C. Menampilkan Dashboard Node-RED</h4>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', marginTop: '5px', marginBottom: '30px' }}>
              <img className="materialboxed" src={picture5} alt="hmi" style={{ maxWidth: '80%', height: 'auto', borderRadius: '10px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }} />
            </div>
            <p>2.	kemudian tampilan dashboard akan muncul seperti berikut.</p>
            <div style={{ display: 'flex', justifyContent: 'center', marginTop: '5px', marginBottom: '30px' }}>
              <img className="materialboxed" src={picture6} alt="hmi" style={{ maxWidth: '80%', height: 'auto', borderRadius: '10px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }} />
            </div>
            <div style={{ display: 'flex', justifyContent: 'center', marginTop: '5px', marginBottom: '30px' }}>
              <img className="materialboxed" src={picture7} alt="hmi" style={{ maxWidth: '80%', height: 'auto', borderRadius: '10px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }} />
            </div>
        </lu>
      </div>
    </div>
